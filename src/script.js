      ...
      <div class="cartao" style="height: fit-content !important; padding-bottom: 16px; min-width: 580px; background-color: #eae9e6; border-radius: 10px !important;">
        <div style="display: flex;">
          ...
          <div style="margin-top: 15px; width: 100%">
            <p style="font-size: 14px; font-weight: 600;">ENDEREÇO DE ENTREGA</p>
...
const bemVindoGuia2Simples = {
  to: ['bruno.yuri.alves@gmail.com'],
    from: 'gruporeserva@usereserva.com',
    //${parametro para pegar o nome do usuário 'primeiro nome'}
    subject: '${<primeiro nome>}, use seus benefícios!!',
    ...
    <body style="max-width: 580px !important;">
      ...
      <div class="info-completa">
        <div class="py-20px" style="padding-left: 30px">
          <p class="semibold" style="font-size: 16px; font-weight: 600;">Olá Pedro!</p>
          <p style="font-size: 14px;"> 
            Como assinante Simples&reg;, você tem acesso a uma série de benefícios exclusivos. Confira todos e as regras para usá-los:
          </p>
        </div>
      </div>  
      <img src="http://app.usereserva.com/imagens/occ/ops1/divisor.png" alt="borda" width="100%" height="1px" />
      ...
      <div style="width: 544px; margin-left: 27px;">
        ...
        <p style="font-size: 15px; text-align: center;">
          Vamos sempre entrar em contato com você, seja para avisar sobre a definição das suas próximas peças ou sobre seus benefícios. Por isso, lembre-se de manter seu 
    ...
    <body style="max-width: 580px !important;">
      ...
      <div class="info-completa">
        <div class="py-20px" style="padding-left: 30px">
          ...
          <p style="font-size: 14px;">
            Este crédito é parte do seu cashback por ser um assinante Simples&reg;.
          </p>
          <p style="font-size: 14px;">
            Ele irá aparecer na etapa “Pagamento” ou será adicionado automaticamente no fechamento da compra, sendo válido em Reserva ou Reserva Mini em compras acima de R$ 85.
          </p>
          <p style="font-size: 14px;">
            Mas atenção: o crédito não acumula e irá expirar daqui a 30 dias. Ou seja, corra para usá-lo antes que você se esqueça. &#x1F609;
          </p>
        </div>
...
const guiaPosAssinaturaSimples = {
  to: ['bruno.yuri.alves@gmail.com'],
    from: 'gruporeserva@usereserva.com',
    subject: '${<primeiro nome>}, agora você é assinante Simples',
    text: 'E tem acesso a diversos benefícios. Confira!',
    html: `<!DOCTYPE html>
    <html style="max-width: 580px !important;">
